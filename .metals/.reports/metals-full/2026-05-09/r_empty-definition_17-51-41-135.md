error id: file://<WORKSPACE>/src/main/java/org/serwin/auth_server/service/AuthService.java:_empty_/UserDto#
...
public class AuthService {
    ...
    public UserDto getCurrentUser(String email) {
        ...
        List<ApiKeyResponse> userApiKeys = authService.listUserApiKeys(user.getEmail())
