error id: file://<WORKSPACE>/src/test/java/org/serwin/auth_server/service/AuthServiceTest.java:_empty_/AuthService#getCurrentUser#
file://<WORKSPACE>/src/test/java/org/serwin/auth_server/service/AuthServiceTest.java
empty definition using pc, found symbol in pc: _empty_/AuthService#getCurrentUser#
empty definition using semanticdb
empty definition using fallback
non-local guesses:

offset: 35933
uri: file://<WORKSPACE>/src/test/java/org/serwin/auth_server/service/AuthServiceTest.java
text:
```scala
...
class AuthServiceTest {
    ...
    class GetCurrentUser {
        ...
        void userNotFound_throwsRuntimeException() {
            ...
            assertThatThrownBy(() -> authService.getCurrent@@User("ghost@example.com"))
                    .isInstanceOf(RuntimeException.class)
                    .hasMessage("User not found");
        }
    }
