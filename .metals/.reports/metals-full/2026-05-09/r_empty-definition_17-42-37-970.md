error id: file://<WORKSPACE>/src/main/java/org/serwin/auth_server/controller/AuthController.java:_empty_/UserDto#
file://<WORKSPACE>/src/main/java/org/serwin/auth_server/controller/AuthController.java
empty definition using pc, found symbol in pc: _empty_/UserDto#
empty definition using semanticdb
empty definition using fallback
non-local guesses:

offset: 11621
uri: file://<WORKSPACE>/src/main/java/org/serwin/auth_server/controller/AuthController.java
text:
```scala
...
public class AuthController {
    ...
    public ResponseEntity<ApiResponse<UserDto>> getCurrentUser() {
        try {
            ...
            U@@serDto user = authService.getCurrentUser(email);
